...
export const googleProvider = new firebase.auth.GoogleAuthProvider();  // setting up Google authentication
googleProvider.setCustomParameters({ prompt: 'select_account' });   // we want to always trigger the Google pop up 
